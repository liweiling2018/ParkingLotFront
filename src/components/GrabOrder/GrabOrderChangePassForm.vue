  ...
  <div>
    <mu-container class="grab-form-container">
      <mu-form ref="form" :model="validateForm" class="mu-demo-form">
        <mu-form-item label="旧密码" prop="old_password" :rules="passwordRules">
            <mu-text-field type="password" v-model="validateForm.old_password" prop="old_password"></mu-text-field>
        </mu-form-item>
        <mu-form-item label="新密码" prop="new_password" :rules="new_passwordRules">
            <mu-text-field type="password" v-model="validateForm.new_password" prop="new_password"></mu-text-field>
        </mu-form-item>
        <mu-form-item label="确认密码" prop="new_password2" :rules="new_passwordRules2">
            <mu-text-field type="password" v-model="validateForm.new_password2" prop="new_password2"></mu-text-field>
        </mu-form-item>
        <mu-form-item>
